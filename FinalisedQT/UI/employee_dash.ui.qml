...
Item {
    ...
    Image {
        id: billing_rect
        source: "images/billing_rect.png"
        x: -3
        y: 385
        opacity: 1
    }
    ...
    Image {
        id: billing-icon
        source: "images/billing-icon.png"
        x: 19
        y: 393
        opacity: 1
    }
