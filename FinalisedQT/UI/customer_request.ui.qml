...
Item {
    ...
    Image {
        id: request_rect
        source: "images/request_rect.png"
        x: -3
        y: 440
        opacity: 1
    }
    Image {
        id: request_icon
        source: "images/request_icon.png"
        x: 16
        y: 451
        opacity: 1
    }
    ...
    Image {
        id: suggest_icon
        source: "images/suggest_icon.png"
        x: 23
        y: 395
        opacity: 1
    }
    ...
    Image {
        ...
        source: "images/enter_items_you_would_like_to_see_in_the_store.png"
        x: 330
        y: 279
        opacity: 1
    }
