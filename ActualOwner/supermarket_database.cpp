    ...
    if(mysql) {
       ...
       mysql_query(mysql, "CREATE TABLE EMPLOYEE_INFO ( ID int NOT NULL AUTO_INCREMENT, NAME "
        ...
        mysql_query(mysql, "CREATE TABLE PRODUCT_INFO ( S_NO int NOT NULL AUTO_INCREMENT, NAME "
                           ...
                           " NOT NULL, QUANTITY INT DEFAULT 1, NO_OF_ITEM_SOLD INT DEFAULT 0, PRIMARY KEY(S_NO))");
...
void insertDataIntoDatabase() {
    ...
    query << "INSERT INTO PRODUCT_INFO(NAME, PRICE, DESCRIPTION, ITEM_TYPE, LOCATION) VALUES " <<
        "('Mango', 150, 'Shipping Date: 2020-03-26', 'Groceries', 'Section A'), "

        "('Cauliflower', 90, 'Shipping Date: 2020-04-06', 'Groceries', 'Section A'), "

        "('Chicken', 360, 'Shipping Date: 2020-05-15', 'Groceries', 'Section A'), "

        "('Milk', 90, 'Shipping Date: 2020-04-24', 'Groceries', 'Section A'), "

        "('Milk Curd', 120, 'Shipping Date: 2020-04-24', 'Groceries', 'Section A'), "

        "('Rice', 365, 'Shipping Date: 2020-04-16', 'Groceries', 'Section A'), "

        "('Light Blue Colored Fancy Pen', 150, 'Shipping Date: 2019-12-26', 'Stationery', 'Section B'), "

        "('Black Pen', 150, 'Shipping Date: 2019-12-26', 'Stationery', 'Section B'), "

        "('Summer Love', 450, 'Shipping Date: 2020-07-28', 'Stationery', 'Section B'), "

        "('You Dont Know JS', 1200, 'Shipping Date: 2020-11-27', 'Stationery', 'Section B'), "

        "('Stationery Box', 600, 'Shipping Date: 2019-10-10', 'Stationery', 'Section B'), "

        "('Nataraj Pencils', 70, 'Shipping Date: 2020-09-24', 'Stationery', 'Section B'), "

        "('Samsung Galaxy A50', 35999, 'Warranty: 1 Year', 'Electronics', 'Section C'), "

        "('Laptop DELL Inspiron 5583', 80200, 'Warranty: 3 Year', 'Electronics', 'Section C'), "

        "('Laptop Lenovo 268', 75000, 'Warranty: 2 Year', 'Electronics', 'Section C'), "

        "('Laptop Acer 5XT', 100200, 'Warranty: 3 Year', 'Electronics', 'Section C'), "

        "('Laptop Mac Book', 150000, 'Warranty: 2 Year', 'Electronics', 'Section C'), "

        "('Fridge', 65250, 'Warranty: 2 Year', 'Electronics', 'Section C'), "

        "('Sony Bravia R202G HD LED TV', 16999, 'Warranty: 1.5 Year', 'Electronics', 'Section C'), "

        "('Samsung Solo Microwave Oven', 13999, 'Warranty: 6 Month', 'Electronics', 'Section C'), "

        "('Coca-cola', 120, 'Expiry-date: 2021-02-26', 'Beverage', 'Section D'), "

        "('Red Wine', 4500, 'Expiry-date: 2021-05-16', 'Beverage', 'Section D'), "

        "('Tubrog', 400, 'Expiry-date: 2021-01-16', 'Beverage', 'Section D'), "

        "('Fanta', 140, 'Expiry-date: 2021-05-16', 'Beverage', 'Section D'), "

        "('Vodka', 1200, 'Expiry-date: 2022-01-14', 'Beverage', 'Section D'), "

        "('Nike hat', 550, 'Manufacture-date: 2019-01-14', 'Clothing', 'Section E'), "

        "('Adidas Shoes', 3500, 'Manufacture-date: 2018-11-06', 'Clothing', 'Section E'), "

        "('Belly Pant', 2500, 'Manufacture-date: 2020-01-14', 'Clothing', 'Section E'), "

        "('Black T-Shirt', 1400, 'Manufacture-date: 2019-11-16', 'Clothing', 'Section E'), "

        "('Gucci belt', 12000, 'Manufacture-date: 2019-05-26', 'Clothing', 'Section E');";
...
void insertEmployeeDataIntoDatabase() {
    ...
    query << "INSERT INTO EMPLOYEE_INFO(NAME, EMAIL, PASSWORD, GENDER, CONTACT_NUMBER, ADDRESS, DATE_OF_BIRTH, WORKING_SINCE) VALUES " <<
        "('Ishan Panta', 'ishan.panta@gmail.com', 'password', 'M', '9841234629', 'banepa', '12-10-2000', '01-12-2018'), "
        "('Mulyankan Sharma', 'mulyankan.sharma@gmail.com', 'password', 'M', '9841234567', 'butwal', '12-10-2001', '01-12-2018'), "
        ...
        "('Johny Cena', 'john.cena@gmail.com', 'password', 'F', '9867597236', 'america', '12-10-2001', '01-12-2018');";
...
void insertShiftDataIntoDatabase() {
    ...
    query << "INSERT INTO SHIFT_DATA(NAME,AGE,DATEJOINED,MONDAY,TUESDAY,WEDNESDAY,THURSDAY,FRIDAY,SATURDAY,SUNDAY) VALUES " <<
             ...
             "('Mulyankan Sharma', '20', '01-12-2018', '9AM-5PM', '8AM-3PM', '11AM-1PM', '8PM-11PM', '9AM-1PM', '3PM-7AM', '8AM-3AM'), "
             "('Abiral Banjade', '24', '01-12-2018', '9AM-5PM', '8AM-3PM', '11AM-1PM', '8PM-11PM', '9AM-1PM', '3PM-7AM', '8AM-3AM'), "
