...
Item {
    ...
    Item {
        ...
        Text{
            x:startofheader+6.5*separation
            y:heightoftext
        ...
        Text {
            x:startofheader+8.3*separation
            y:heightoftext
...
ScrollView{
    ...
    ListView{
        ...
        delegate: ItemDelegate{
                ...
                Text {
                    x:startofheader+3.6*separation
                    y:10
                    id: itemPrice
                    text: model.PRICE
                    font.pixelSize: fontsize
